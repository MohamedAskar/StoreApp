...
import 'package:store/screens/store_bottomsheet_cart.dart';
...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    FlutterStatusbarcolor.setStatusBarColor(
        _backButtonPressed ? Colors.white : Theme.of(context).cardColor);
                ...
                child: Row(
                  children: <Widget>[
                    FloatingActionButton(
                      ...
                      onPressed: () {
                        setState(() {
                          storeItem.isFavorite = !storeItem.isFavorite;
                        });
                      },
                      child: Icon(
